...
public class IfElseStatements
{
    public void Run()
    {
        ...
        if (true) Console.WriteLine("This will always print");

        if (false) Console.WriteLine("This will never print");

        // we can use variables as the condition to check
        // remember boolean variables?
        // let's use one here!
        var condition = true;
        if (condition) Console.WriteLine("This prints when the condition is true!");
