...
public class TextBoxPage : BasePage
{
    ...
    [FindBy(Id = "userName-label")] public Element? UserNameLabel { get; set; }

    [FindBy(Id = "userName")] public Input? UserName { get; set; }

    [FindBy(Id = "userEmail-label")] public Element? UserEmailLabel { get; set; }

    [FindBy(Id = "userEmail")] public Input? UserEmail { get; set; }

    [FindBy(Id = "currentAddress-label")] public Element? CurrentAddressLabel { get; set; }

    [FindBy(Id = "currentAddress")] public Input? CurrentAddress { get; set; }

    [FindBy(Id = "permanentAddress-label")]
    public Element? PermanentAddressLabel { get; set; }

    [FindBy(Id = "permanentAddress")] public Input? PermanentAddress { get; set; }

    [FindBy(XPath = "//*[@id='submit']")] public Button? Submit { get; set; }

    [FindBy(Id = "output")] public Element? Output { get; set; }
